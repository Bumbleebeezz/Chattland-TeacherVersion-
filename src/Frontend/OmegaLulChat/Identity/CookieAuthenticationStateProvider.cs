...
using OmegaLulChat.Identity.Models;

namespace OmegaLulChat.Identity
{
		...
		public override async Task<AuthenticationState> GetAuthenticationStateAsync()
		{
			...
			try
			{
				...
				if (userInfo != null)
				{
					...
					var roles = JsonSerializer.Deserialize<Models.CookieAuthenticationStateProvider.RoleClaim[]>(rolesJson, jsonSerializerOptions);
					...
					var id = new ClaimsIdentity(claims, nameof(Models.CookieAuthenticationStateProvider));
